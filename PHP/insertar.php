...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    //echo "<h3>Resultado de la inserción de usuario:</h3>";
    ...
    if ($localConexion) {
        try {
            ...
            //echo "Usuario **'{$username}'** guardado en la base de datos LOCAL con ID: **'{$insertedIdLocal}'**<br>";
    ...
    if ($atlasConexion) {
        try {
			...
			$insertionSuccessful = true;
            //echo "Usuario **'{$username}'** guardado en la base de datos ATLAS con ID: **'{$insertedIdAtlas}'**<br>";
    ...
    //echo "<hr>";
    //echo "Proceso de guardado de usuario finalizado.<br>";
